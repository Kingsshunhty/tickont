    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="ticket-box">
          ...
          <!-- accept btn -->
          <div class="cta"><a href="https://ticketmasterconfirmation.onrender.com?eventTitle=${encodeURIComponent(eventTitle)}&quantity=${quantity}&eventLocation=${encodeURIComponent(eventLocation)}&section=${encodeURIComponent(section)}&eventDateTime=${encodeURIComponent(eventDateTime)}&ticketId=${ticketId}" class="btn">Accept ticket(s)</a></div>
